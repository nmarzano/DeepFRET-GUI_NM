...
class SimulatorWindow(BaseWindow):
    ...
    def valuesFromGUI(self):
        ...
        if self.ui.checkBoxRandomState.isChecked():
            ...
            new_fret_means = sorted(
                deepfret_nm.main.python.lib.utils.numstring_to_ls(self.ui.inputFretStateMeans.text())
            )
    ...
    def generateTraces(self, examples: bool):
        ...
        df = deepfret_nm.main.python.lib.math.generate_traces(
            n_traces=n_traces,
    ...
    def refreshPlot(self):
        ...
        for i in range(n_subplots):
            ...
            deepfret_nm.main.python.lib.plotting.plot_simulation_category(
