...
def generate_traces(
    ...
    def generate_single_trace(*args):
        ...
        for j in range(n_pairs):
            ...
            first_bleach = deepfret_nm.main.python.lib.utils.min_none((bleach_D, bleach_A))
        ...
        if is_aggregated:
            ...
            first_bleach_all = deepfret_nm.main.python.lib.utils.min_none(
            ...
            first_bleach_all = deepfret_nm.main.python.lib.utils.min_none(first_bleach_all)
