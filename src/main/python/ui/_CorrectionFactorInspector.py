...
# Form implementation generated from reading ui file 'src/main/python/ui/CorrectionFactorInspector.ui'
#
...
class Ui_CorrectionFactorInspector(object):
    def setupUi(self, CorrectionFactorInspector):
        ...
        self.alphaFactorBox = QtWidgets.QDoubleSpinBox(
        ...
        sizePolicy.setHeightForWidth(
            self.alphaFactorBox.sizePolicy().hasHeightForWidth()
        )
        ...
        self.alphaFactorBox.setButtonSymbols(
        ...
        spacerItem2 = QtWidgets.QSpacerItem(
            31, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum
        )
        self.gridLayout.addItem(spacerItem2, 0, 0, 1, 1)
        self.deltaFactorBox = QtWidgets.QDoubleSpinBox(
            CorrectionFactorInspector
        )
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed
        ...
        spacerItem4 = QtWidgets.QSpacerItem(
            35, 0, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum
        )
    ...
    def retranslateUi(self, CorrectionFactorInspector):
        ...
        CorrectionFactorInspector.setWindowTitle(
            _translate("CorrectionFactorInspector", "Dialog")
        )
        self.label_2.setText(
            _translate("CorrectionFactorInspector", "global δ-Factor:")
        )
        self.label.setText(
            _translate("CorrectionFactorInspector", "global ɑ-Factor:")
        )
